...
namespace CsharpAdvanced.LINQquerySyntax
{
    public class ConversionOperators
    {
        ...
        public int ConvertToDictionary()
        {
            ...
            var scoreRecords = new[] { new {Name = "Ali", Score = 50},
                                new {Name = "Bahareh"  , Score = 40},
                                new {Name = "Mahdiye", Score = 45}
                            };

            var scoreRecordsDict = scoreRecords.ToDictionary(sr => sr.Name);

            Console.WriteLine("Bahareh's score: {0}", scoreRecordsDict["Bahareh"]);
            #endregion
            return 0;
        }
